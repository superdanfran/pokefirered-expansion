...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_STORM_DRAIN, ABILITY_RAIN_DISH },
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .abilities = { ABILITY_STRONG_GNAW, ABILITY_GUTS, ABILITY_HUSTLE },
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SNIPER, ABILITY_NONE, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_BROWN,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MERCILESS, ABILITY_QUEENLY_MAJESTY, ABILITY_SHEER_FORCE },
    #else
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_POISON_POINT, ABILITY_MOXIE, ABILITY_HUSTLE },
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_NONE, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_NIDOKING] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_DEFIANT, ABILITY_MOXIE, ABILITY_SHEER_FORCE },
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_NONE, ABILITY_SHEER_FORCE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_RUN_AWAY, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GLOOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_STENCH, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gloom"),
        .cryId = CRY_GLOOM,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_WATER_ABSORB, ABILITY_DAMP },
    #else
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_SHADOW_TAG, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_SHADOW_TAG, ABILITY_PERISH_BODY}
#else
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STATIC, ABILITY_GUTS, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
    ...
    [SPECIES_ELECTIVIRE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_MOTOR_DRIVE, ABILITY_GUTS, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_UNNERVE, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Magby"),
        .cryId = CRY_MAGBY,
